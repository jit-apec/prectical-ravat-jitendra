...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="post" action="{{ url('/admin/product/edit', $products->id) }}" id="form_validation">
                @csrf
                <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="product_tag">Select Tag<span class="text-danger">*</span></label>
                                    @error('product_tag')
                                        <strong>{{ $message }}</strong>
                                    @enderror
                                    <select id="product_tag" name="tag" class="form-control">
                                        <option selected>{{ $products->tag }}</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" name="price" id=""
                                            value="{{ $products->price }}" pattern="[0-9]{1,6}"
